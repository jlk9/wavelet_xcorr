...
NOTE: this is identical to compute_vectorized_timelags in the file of the same name
    in dense_code. Eventually this function may be implemented differently to take advantage
    of sparsity, hence the separation between it and the dense one. If you make changes to
    one function, you should change both.
"""
def compute_vectorized_timelags_sparse(xcorr_matrices, left_diags, right_diags, coeff1_begins,
...
NOTE: this is identical to mixed_compute_vectorized_timelags in the file compute_vectorized_timelags
    in dense_code. Eventually this function may be implemented differently to take advantage
    of sparsity, hence the separation between it and the dense one. If you make changes to
    one function, you should change both.
"""
def mixed_compute_vectorized_timelags_sparse(xcorr_matrices, diags):
